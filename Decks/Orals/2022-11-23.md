...
Definition 1.1.9. Let $\sigma \subseteq N_{\mathbb{R}}$ be a scrapc,
(i) $\sigma$ is smooth if its minimal generators form part of a $\mathbb{Z}$-basis for $N$.
(ii) $\sigma$ is simplicial if its minimal generators are linearly independent over $N_{\mathbb{R}}$.
